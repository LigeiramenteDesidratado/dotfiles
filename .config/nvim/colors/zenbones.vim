...
if &background ==# 'dark'
    ...
    highlight Comment guifg=#6E6763 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight Conceal guifg=#797F84 guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight! link LightspeedMaskedChar Conceal
    highlight Constant guifg=#868C91 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    highlight Italic guifg=NONE guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    highlight Number guifg=#B4BDC3 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    highlight SpecialKey guifg=#5C534F guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    highlight diffNewFile guifg=#819B69 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight diffOldFile guifg=#DE6E7C guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    highlight! link LspReferenceText ColorColumn
    highlight! link LspReferenceWrite ColorColumn
    highlight Comment guifg=#948985 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight Conceal guifg=#4F5E68 guibg=NONE guisp=NONE gui=bold cterm=bold
    highlight! link LightspeedMaskedChar Conceal
    highlight Constant guifg=#556570 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight! link TroubleSource Constant
    highlight! link WhichKeyValue Constant
    highlight! link helpHyperTextJump Constant
    highlight! link helpOption Constant
    ...
    highlight Number guifg=#2C363C guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight! link Boolean Number
    highlight! link TSConstBuiltin Number
    highlight! link TSConstMacro Number
    highlight! link TSVariableBuiltin Number
    ...
    highlight! link markdownTSURI SpecialComment
    highlight SpecialKey guifg=#BBABA3 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight! link markdownTSStringEscape SpecialKey
    ...
    highlight diffNewFile guifg=#4F6C31 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    highlight diffOldFile guifg=#A8334C guibg=NONE guisp=NONE gui=NONE cterm=NONE
